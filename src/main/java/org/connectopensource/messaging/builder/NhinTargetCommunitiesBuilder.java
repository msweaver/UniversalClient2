...
/**
 * The Interface NhinTargetCommunitiesBuilder.
 *
 * @author msw
 */
public interface NhinTargetCommunitiesBuilder extends Builder{
    
    /**
     * Gets the nhin target communities.
     *
     * @return the nhin target communities
     */
     ...
     * Sets the target.
     *
     * @param targetHCID the new target
     */
     ...
     * Sets the targets.
     *
     * @param targetHCIDs the new targets
     */
