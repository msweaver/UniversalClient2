...
/**
 * The Interface AdapterDocumentRetrieveMessageDirector.
 *
 * @author msw
 */
public interface AdapterDocumentRetrieveMessageDirector extends Builder {
    /**
     * Gets the message.
     * 
     * @return the message
     ...
     *
     * @param drBuilder the new document builder
     */
    public void setDocumentBuilder(DocumentRequestBuilder drBuilder);
